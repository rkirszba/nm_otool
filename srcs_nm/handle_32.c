...
/*   Updated: 2021/01/19 20:24:32 by rkirszba         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int8_t	symbol_get_32(t_file_data *file, struct nlist *sym)
{
	...
	new_symbol->value = endian_wrap_u32(sym->n_value, file->endian);
...
static int8_t	symbols_get_32(t_file_data *file)
{
